...
function ForgotPassword() {
    ...
    const postData = async (obj) => {
        try {
            let response = await axios.post("/student/forgotPassword", obj);
            ...
            console.log("Registration data -> ", errorResponse);
                    ...
                    <div className='py-24 px-10'>
...

                        {
                            ...
                            <>
                                ...
                                <div className='text-center mt-4'><Link to="/student/login"><button className="btn btn-block gradiant-btn ">Login</button></Link></div>
...

                        {
                            ...
                            <>
                                ...
                                <form onSubmit={(e) => submitForm(e)}>
                                    ...
                                    <div className='text-center mt-4'>Don't have an account yet? <Link to="/student/register"><button className="inline-block blue-link">Register</button></Link></div>
                                </form>
                            </>
                        }
