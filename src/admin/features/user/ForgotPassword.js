...
function ForgotPassword() {
    ...
    const postData = async (obj) => {
        try {
            let response = await axios.post("/admin/forgotPassword", obj);
                    ...
                    <div className='py-24 px-10'>
...

                        {
                            ...
                            <>
                                ...
                                <div className='text-center mt-4'><Link to="/admin/login"><button className="btn btn-block gradiant-btn ">Login</button></Link></div>
...

                        {
                            ...
                            <>
                                ...
                                <form onSubmit={(e) => submitForm(e)}>
                                    ...
                                    <div className='text-center mt-4'>Go to <Link to="/admin/login"><button className="inline-block blue-link">Login</button></Link></div>
                                </form>
                            </>
                        }
