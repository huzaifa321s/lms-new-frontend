...
import { createCourse, editCourse } from './coursesSlice'
...
const CreateForm = () => {
  ...
  const handleMaterialFileUpload = (i, e) => {
    const file = e.target.files[0];
    const updatedMaterials = [...courseObj.material];
  ...
  },[courseObj,removedMaterial,axios,toast]);
    ...
    <div>
      ...
      <div className='mb-4 w-full flex justify-between'>
        <div className='text-2xl font-semibold flex items-center gap-2'>
          {id ? "Course Details" : "Create New Course"}
        </div>
      ...
      <div className='card w-full p-6 bg-base-100 shadow-xl mt-2'>
        ...
        <div className="mt-12">
          ...
          >
            {id ? "Update Details" : "Create Course"}
          </button>
        </div>
