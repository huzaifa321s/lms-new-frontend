        ...
        <>
            <article className="prose">
              ...
              <h2 id="feature1">Authentication</h2>
                <p>
                   JWT based Authentication logic is present in <span className="badge mt-0 mb-0 badge-ghost">/teacher/auth.js</span>. In the file you can see we are adding bearer token in header for every request. Every routes under <span className="badge mt-0 mb-0 badge-ghost">/routes/</span> folder will need authentication. For public routes like login, register you will have to add routes in <span className="badge mt-0 mb-0 badge-ghost">App.js</span> file and also include the path in PUBLIC_ROUTES variable under <span className="badge mt-0 mb-0 badge-ghost">/teacher/auth.js</span> file so that auto redirect to login page is not triggered.
            ...
            <h2 id="feature3">Add New Page</h2>
                ...
                <ul className='mt-0'>
                        ...
                        <li>Add your new route path in <span className="badge mt-0 mb-0 badge-ghost">/teacher/auth.js</span> file under PUBLIC_ROUTES variable, this will allow the page to open without login.</li>
                </ul>
